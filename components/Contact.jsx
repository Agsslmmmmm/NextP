  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8" id='contact'>
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-600 sm:text-4xl">Contact sales</h2>
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-3xl bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white p-4 hover:scale-105 transition-all duration-500 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 shadow-indigo-600 shadow-lg"
          >
            Send
          </button>
        </div>
